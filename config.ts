...
interface ENV {
  ...
  DEFAULT_PAGE_SIZE: string | undefined;
  DEFAULT_PAGE_NUMBER: string | undefined;
  ...
  SMTP_REDIRECTION_URL: string | undefined;
...
const getConfig = (): ENV => {
  return {
    ...
    SMTP_REDIRECTION_URL: process.env.SMTP_REDIRECTION_URL,
