...
export class GenericLookupController<T> {
    ...
    async getAll(_: Request, res: Response) {
        try {
            return new ResponseHandlingService(res, await this.genericLookupService.getAll(), StatusCodes.OK);
        }
        catch(error: any) {
            return new ResponseHandlingService(res, new ErrorResponse(error.message, StatusCodes.InternalServerError, error), StatusCodes.InternalServerError);
        }
    }
    ...
    async getOne(req: Request, res: Response) {
        try {
            ...
            if (!roleInDb) {
                return new ResponseHandlingService(res, new ErrorResponse(`Can not find ${this.lookupName} with ID: ${id}`, StatusCodes.NotFound), StatusCodes.NotFound);
            }
    ...
    async create(req: Request, res: Response) {
        try {
            ...
            return new ResponseHandlingService(res, await this.genericLookupService.create(newRole), StatusCodes.Created);
        }
        catch(error: any) {
            return new ResponseHandlingService(res, new ErrorResponse(error.message, StatusCodes.InternalServerError, error), StatusCodes.InternalServerError);
        }
    ...
    async update(req: Request, res: Response) {
        try {
            ...
            return new ResponseHandlingService(res, await this.genericLookupService.update(existingLookupInDB), StatusCodes.OK);
        }
        catch(error: any) {
            return new ResponseHandlingService(res, new ErrorResponse(error.message, StatusCodes.InternalServerError, error), StatusCodes.InternalServerError);
        }
    ...
    async delete(req: Request, res: Response) {
        try {
            ...
            return new ResponseHandlingService(res, new MessageResponse(`The ${this.lookupName} has been deleted successfully`), StatusCodes.OK);
        }
        catch(error: any) {
            return new ResponseHandlingService(res, new ErrorResponse(error.message, StatusCodes.InternalServerError, error), StatusCodes.InternalServerError);
        }
