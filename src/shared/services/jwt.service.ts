...
export class JwtService {
    ...
    constructor() {
        this.privateKeyPath = path.join(config.TOKEN_KEYS_PATH, config.TOKEN_PRIVATE_KEY_NAME);
        this.publicKeyPath = path.join(config.TOKEN_KEYS_PATH, config.TOKEN_PUBLIC_KEY_NAME);
        this.expiry = 3600000;
    }
